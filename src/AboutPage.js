      ...
      <section className="d-flex flex-row mb-3 pt-4">
        <div className="about-desc-box justify-content-center ms-4 me-4">
          ...
          <p className=" desc fs-5">
            ...
            connect businesses like restaurants and stores who are looking to give away extra food to
        ...
        <div className="about-img-box me-3">
          <img className="ballard-food-bank-img" src="img/about-store.jpeg" alt="Ballard Food Bank"/>
          <p className="ballard-cap">Image from <a className="ballard-cap" href="https://www.ballardfoodbank.org/">Ballard Food Bank</a></p>
        </div>
      </section>
      <section>
        <div className="goals ms-4">
          <h1>Our Goals</h1>
          <div className="d-flex flex-row">
            <div className="Acard">
              <img src="img/about-giving-food.webp" className="card-img-top" alt="Seattle Restaurant employee giving a woman and her child food."/>
            ...
            <div className="Acard">
              <img src="img/about-successful-food-drive.webp" className="card-img-top" alt="A young girl and woman volunteering at a food drive."/>
              <div className="card-body">
                <p className="card-text">
                  Increasing invisibility of food drive events.
                </p>
              </div>
            </div>
            <div className="Acard">
              <img src="img/about-seattle-road-map.jpeg" className="card-img-top" alt="A map of seattle."/>
              <div className="card-body">
                <p className="card-text">
